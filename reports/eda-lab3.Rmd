...
As séries listadas acima foram algumas das mais assistidas e comentadas ano de 2017 segundo o site Adoro Cinema(link), nas quais iremos fazer alguns questionamentos e chegar ao resultado se realmente elas conquistaram o público ou não.
...
Obs.: No banco do IMDB não é fornecido o gênero das séries, então pesquisei no site Adoro Cinema.
